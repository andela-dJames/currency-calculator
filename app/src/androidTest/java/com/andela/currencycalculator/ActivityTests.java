...
public class ActivityTests {
    ...
    public void testClickPlusOperatorAddsAnOperand() {
        ...
        onView(withId(R.id.key_two)).perform(click());
        onView(withId(R.id.key_equal)).perform(click());
        onView(withId(R.id.result_text_view)).check(matches(withText(containsString("3"))));
    }
    @Test
    public void testClickminusOperatorSubtractsAnOperand() {
        ...
        onView(withId(R.id.key_two)).perform(click());
        onView(withId(R.id.key_equal)).perform(click());
        onView(withId(R.id.result_text_view)).check(matches(withText(containsString("-1.0"))));
    }
    @Test
    public void testBaseCurrencyDialog() {
//        onView(withId(R.id.key_one)).perform(click());
        onView(withId(R.id.key_base)).perform(click());
       onView(withText(R.string.select_currency)).check(matches(isDisplayed()));
    }

    @Test
    public void testTargetCurrencyDialog() {
//        onView(withId(R.id.key_one)).perform(click());
        onView(withId(R.id.key_target)).perform(click());
        onView(withText(R.string.select_target)).check(matches(isDisplayed()));
    }
